...
---@alias Request lib.lsp.Response[]|table<any,any>
...
---@field _register_float_actions fun(self:lsp.ui,data:lib.win.Data,any...)? @Register autocommands, buffer-local keymaps, or similar.
